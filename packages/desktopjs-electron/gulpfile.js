...
gulp.task(
  ...
  require("../../.gulp/tasks/dts")(
    gulp,
    pkg.name,
    gulpConfig.staging.dest + "/src/electron.d.ts",
    "../../" + pkg.types
  )
);
gulp.task(
  ...
  gulp.parallel(
    ...
    require("../../.gulp/tasks/compress")(
      gulp,
      gulpConfig.dest + "/iffe/desktopjs-electron.js",
...
gulp.task("watch", () =>
  gulp.watch(
    [
      ...
      "*.json",
      "*.js",
      "node_modules/@morgan-stanley/desktopjs/dist/desktop.js",
    ],
